...
bash scripts/finetuning_drag.sh 1 bunny 0000 1000 && \
bash scripts/finetuning_drag.sh 1 clock 0000 1500 && \
bash scripts/finetuning_drag.sh 1 dog 0177 0279

bash scripts/finetuning_drag.sh 2 horse 0120 0375 && \
bash scripts/finetuning_drag.sh 2 hour_glass 0000 1755 && \
bash scripts/finetuning_drag.sh 2 k1_double_punch 0000 0555 && \
bash scripts/finetuning_drag.sh 2 k1_hand_stand 0000 0300

bash scripts/finetuning_drag.sh 3 k1_push_up 0370 0398 && \
bash scripts/finetuning_drag.sh 3 music_box 0095 0129 && \
bash scripts/finetuning_drag.sh 3 penguin 0217 0239 && \
